    ...
    : DiscountProtoService.DiscountProtoServiceBase
{
    public override async Task<CouponModel> GetDiscount(GetDiscountRequest request, ServerCallContext context)
    {
        ...
        {
            coupon = new Coupon
                { ProductName = "No Discount", Amount = 0, Description = "No Discount for this Product" };
        }

        logger.LogInformation("Discount for productName: {productName} ,amount: {amount}", coupon.ProductName,
            coupon.Amount);
